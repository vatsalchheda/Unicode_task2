...
class App extends React.Component {
  ...
  return (
        <form>
          ...
          <h1>Your First name is <span className="Cred">{this.state.fname} </span> </h1>
          <h1>Your Last name is <span className="Cred"> {this.state.lname} </span> </h1>
          <h1>Your BirthDate is <span className="Cred"> {this.state.Bdate} </span> </h1>
          </div>
        </form>
  );
  }
